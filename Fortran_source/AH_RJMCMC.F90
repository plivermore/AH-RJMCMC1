...
REAL( KIND = 8), ALLOCATABLE :: X(:),  PRIOR_INTENSITY_TIME_DEPENDENCE_FILE(:,:)
...
NUMBER_PRIOR_INTENSITY_POINTS = i-1

ALLOCATE( PRIOR_INTENSITY_TIME_DEPENDENCE(NUMBER_PRIOR_INTENSITY_POINTS,3))
PRIOR_INTENSITY_TIME_DEPENDENCE = PRIOR_INTENSITY_TIME_DEPENDENCE_FILE(1:NUMBER_PRIOR_INTENSITY_POINTS,1:3)
