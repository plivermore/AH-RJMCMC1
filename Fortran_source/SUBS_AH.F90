...
IF( STRATIFICATION(J) .NE. STRATIFICATION(I)+1) THEN
CHECK_STRATIFICATION = .FALSE.
PRINT*, 'PROBLEM IN DATA FILE, PERHAPS STRATIFICATION INDICES ARE NOT ORDERED PROPERLY? PROBLEM IS HERE :', ages(I), ages(J)
RETURN
ENDIF
